...
export const SlideNotificationAffiliation: React.FC<SlideNotificationAffiliationProps> = ({ activeTab, onUpgrade }) => {
  ...
  return (
    <div className="fixed top-24 left-4 z-[100] max-w-[380px] w-[calc(100%-2rem)] animate-in slide-in-from-left-10 fade-in duration-700">
      <div className="relative overflow-hidden rounded-2xl border border-[#D4AF37]/40 bg-[#050505] shadow-[0_20px_50px_rgba(0,0,0,0.8)] shadow-violet-900/20 backdrop-blur-md">
        ...
        <div className="relative p-5 flex flex-col gap-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 pr-4">
              ...
              <p className="text-gray-400 text-[12px] mt-1">
                Certains ambassadeurs ont généré plus de <span className="text-[#D4AF37] font-bold"><CurrencyDisplay amount={100000} inline /></span> avec la bonne stratégie.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="group relative w-full py-3 rounded-xl bg-violet-900 hover:bg-violet-800 border border-[#D4AF37]/60 text-white font-bold text-sm transition-all duration-500 flex items-center justify-center gap-2 overflow-hidden shadow-xl hover:scale-105 active:scale-95 animate-pulse-slow"
          >
            {/* Shine effect */}
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        @keyframes pulse-slow {
          ...
          50% { transform: scale(1.02); box-shadow: 0 10px 25px -3px rgba(139, 92, 246, 0.3); }
        }
        .animate-pulse-slow {
