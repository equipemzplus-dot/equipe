...
export const GuideStep: React.FC<GuideStepProps> = ({ 
  ...
  return (
    <div
      ...
      className={`z-[9999] bg-white/95 backdrop-blur-xl shadow-[0_40px_100px_rgba(0,0,0,0.25)] border border-yellow-600/10 animate-in fade-in duration-500 ${
        isPanel 
          ? 'w-[calc(100%-32px)] max-w-[460px] rounded-[2.5rem] p-6 md:p-10 slide-in-from-top-10' 
          : 'w-[280px] rounded-[2.5rem] p-6 zoom-in-95'
      }`}
    >
      {onClose && (
        <button 
