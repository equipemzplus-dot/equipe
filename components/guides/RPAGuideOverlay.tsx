...
interface RPAGuideOverlayProps {
  targetRect: DOMRect | null;
  isVisible: boolean;
}

export const RPAGuideOverlay: React.FC<RPAGuideOverlayProps> = ({ targetRect, isVisible }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9998] pointer-events-none overflow-hidden animate-in fade-in duration-300">
      ...
      {/* Halo / Glow effect around the hole - Purple for RPA */}
      <div
        className="absolute border border-purple-500/40 rounded-[2.5rem] shadow-[0_0_60px_rgba(168,85,247,0.2)] pointer-events-none animate-in zoom-in-95 duration-500"
        style={{
          top: top - padding,
          left: left - padding,
