...
export const PWAInstallPrompt: React.FC = () => {
  ...
  const [platformIcon, setPlatformIcon] = useState<string>("https://images.chariowcdn.com/cdn-cgi/image/format=auto,onerror=redirect,quality=medium-high,slow-connection-quality=50/https://assets.chariowcdn.com/assets/store_9odbnsabvmpf/UFnbTtas4byaZS9QIcppPzeG1ELvZwh6grrQEDai.png");
  ...
  return (
    <div className="fixed bottom-24 left-4 right-4 z-[9999] md:left-auto md:right-8 md:bottom-8 md:w-80 animate-in fade-in slide-in-from-bottom-10 duration-500">
